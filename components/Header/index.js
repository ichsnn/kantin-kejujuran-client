        ...
        <dir className="container">
          <div className="flex justify-between items-center gap-4">
            <div className="flex flex-1 items-center gap-5">
              <h1 className="font-work-sans text-3xl text-white font-bold relative  whitespace-nowrap">
    ...
    <header className="bg-sky-500 pt-6 pb-5 shadow-md">
      <dir className="container">
        <div className="flex justify-between items-center gap-4">
          <div className="flex flex-1 items-center gap-5">
            <Link href={"/"}>
              <a className="font-work-sans text-3xl text-white font-bold relative whitespace-nowrap">
                canteen.
              </a>
            </Link>
            <nav className="w-full">
